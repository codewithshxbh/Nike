...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                <Text className="typeWritertheme"> Copyright © - Shubhendu Chakrabarti</Text>
            </Center>
            ...
            >
                ...
                >
                    <IconLink
                        ...
                        link={"https://shubhenduchakrabart.netlify.app"}
                    />
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/codewithshxbh/"}
                    />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/shubhenduchakrabarti/"}
                    />
                </Flex>
